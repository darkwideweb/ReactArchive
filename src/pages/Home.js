  ...
  const sections = [
    {
      ...
      description: 'Откройте для себя примеры использования различных React-компонентов с Material UI — от Google.',
      link: '/components',
    },
    {
      title: 'Интерактивные викторины',
      description: 'Проверьте свои знания, проходя увлекательные викторины по React.',
      link: '/quizzes',
    },
    {
      title: 'Полезные ресурсы',
      description: 'Доступ к актуальным и полезным ресурсам по React и веб-разработке.',
      link: '/resources',
    },
    {
      title: 'Проектные работы',
      description: 'Идея и реализация для первого проекта на React.',
      link: '/project-labs',
    },
    {
      title: 'Интерактивный IDE',
      description: 'Попробуйте написание и тестирование кода прямо в браузере.',
      link: '/code-editor',
    },
    {
      title: 'Креативные челленджи',
      description: 'Примите участие в креативных челленджах.',
      link: '/creative-challenges',
    },
  ];  
